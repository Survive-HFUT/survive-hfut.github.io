<img src="docs/public/book.png" width="120" align="right" alt="Survive-HFUT Logo" />

# 活在肥宣 · Survive-HFUT

肥工生存手册 · 更适合合工大学生的生活指南

|              主站              |              镜像站              |
| :----------------------------: | :------------------------------: |
| **<https://survive-hfut.cc/>** | <https://survive-hfut.klps.top/> |

- 这是一份面向合工大学生的生活指南，最初主要针对**宣城校区**编写，目前也在持续完善**合肥校区**相关内容。[加入我们！](#贡献--参与方式)
- 我们希望通过更系统、更易检索的方式，把校园学习、生活、办事与常见问题汇总成一个可靠的入口。
- 网站内大部分页面都有严谨的引用来源标注，完全无广，纯为爱发电，可安心食用。

> [!warning]
> 这**不是**合肥工业大学的官方文档。
>
> 此文档目前主要由学生维护，所有内容均不代表校方官方观点和意见。因更新滞后或其他问题，部分内容可能与实际情况存在出入，请以学校发布的相关管理办法为准
