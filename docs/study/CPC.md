...
:::tip 详细流程
更多关于发展党员的 5 个阶段 25 个步骤的详细信息，请参考共产党员网官方专题：[发展党员流程及步骤](https://www.12371.cn/special/fzdylc/)[^1]
:::

- 班干部在入党时还是有一些优势（还有国旗护卫队，他们入党有单独的名额，相较之下比较容易）。
- **团员推优**：大学里通常 **一年进行两次** 推优工作，且只有团员才能在大学里推优入党。
- **考核时长**：成为入党积极分子后，需经过 **一年以上** 的培养教育和考察，才可参加发展对象推荐。
- **时间规划**：整个过程耗时较长（成为正式党员最快也需要两年），建议有入党想法的同学尽早在 **大一** 时就提交入党申请书并争取竞选积极分子。

### 党校培训

入党入团通常会被要求参加党校学习。党校培训**每学期开设一次**，分为 **线下培训** 与 **线上学习**，二者通常同步进行。

#### 线下培训

- **期数**：截至目前，线下党校为第 29 期 (2026.3.25 开班)。
- **地点**：通常在 **大学生活动中心大礼堂** 进行。
- **安排**：一般包含 4 次课程培训。
- **时间**：通常安排在下午 16:00 - 17:30。
- **环节**：包含 **开班典礼**、**开班第一讲**、**集中授课**、**研讨交流**、**主题实践**、**培训心得**、**结业考核** 等环节。

#### 线上学习

- **平台**：[合肥工业大学党校在线](http://cas.hfut.edu.cn/cas/login?service=http://wsdx.hfut.edu.cn/user/cas_login/login)（也可从 [信息门户](https://one.hfut.edu.cn/) - 业务系统 - 党校在线 进入）。
- **期数**：截至目前，线上党校为第 75 期(2026.3.25 开班)。
- **环节**：包含 **理论学习**、**心得体会** 和 **结业测试** 三个环节。
  - **理论学习**：需按要求完成选修和必修课时。
...
[^1]: 共产党员网. 发展党员工作流程及文档下载[DB/OL]. [2026-05-07]. <https://www.12371.cn/special/fzdylc/>
