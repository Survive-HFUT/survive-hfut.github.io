...
- 跨专业选修课学分在计划之外，算专业选修（<mark>挂科有不及格记录</mark>）、毕业要求至少 2 学分，但是不计入培养方案的专业选修部分（<mark>无法用来替代并退掉本专业的课程</mark>）
- <mark>在培养方案中可以直接查找符合条件的四史、美育类课程</mark>，此处的美育类课程就是教育部指的公共艺术课程，包括美学和艺术史论类、艺术鉴赏和评论类、艺术体验和实践类等三种类型课程，<mark>实际上只要选 1 学分的美学和艺术史论类 和 1 学分的艺术鉴赏和评论类课程 即可</mark>。[^3]
...
[^3]:
    教育部办公厅关于印发《高等学校公共艺术课程指导纲要》的通知[DB/OL]. (2022-11-22)\[2025-12-10].
    <https://www.gov.cn/zhengce/zhengceku/2022-12/02/content_5729980.htm>
