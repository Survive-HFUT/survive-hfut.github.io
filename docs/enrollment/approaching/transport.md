...
可选择合肥南站或合肥站，二者距离都差不太远

== 宣城校区

:::tip

入学报道期间、开学前和放假前，学校会派大巴车在==宣城站==迎接新生，上车前务必认准合工大标识
...
- 宣城站到学校的公交可详见[生活§交通](../../life/transportation/public)
...
- 没有学生证的大一新生可以先用录取通知书在 12306 上验明学生资质并购买学生票，==凭录取通知书从人工检票口检票进站==[^5]
- 后续等学生证下发后，每年有 4 次的优惠次数（于每年 10 月 1 日重置），但仅限于学生证中登记的居住地与学校之间的往返[^5]
- 毕业生因学生证回收，可凭==盖有院校公章的学校书面证明==购买学生票[^4]
...
车票于开车日期前 14 天开始售卖。每个站点的开票时间有所不同，前述 7 座宣城境内高铁站==出发车票==起售时间均为 10:00 [^1]

你可以提前在第三方 App（携程、同程等） 上查看未来超过 14 天的发车情况和放票时间。使用第三方软件购票时，推荐使用 ==登录 12306 账号== 功能购票避免加价和个人信息泄露

除此之外，第三方平台还可能根据实际情况推出以下等功能，这在不方便监控余票时很好用

#### 买短乘长（越站乘车）

购票区间==短于==实际乘车区间，并于车上补票
...
- ==在车票到站后不下车继续乘车的，将按无票处理。出站时除了要补票外，还将加收 50% 已乘区间应补票款。==[^3]
...
12306 中的中转方案较少，而第三方平台提供的方案更多且可根据个人需求进行自定义，且包含三次中转或包含轮渡/飞机中转的方案
...
从芜宣机场打车至宣区北门需要约一百块，不过你也可以在微信小程序`#小程序://皖美出行Lite/VAjgAcYxYtMyPHw`上购买 芜宣机场 ↔ 宣城客运站 的大巴车车票，票价为 10 元 <Note>此条线路可能已停运</Note>
