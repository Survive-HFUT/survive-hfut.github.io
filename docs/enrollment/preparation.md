...
- 若干百元大钞
- 学校发放的银行卡
- 家庭经济不怎么乐观的，带上贫困证明及其复印件，国家贫困助学金申请（这个申请录取通知书里边的有复印完之后填好各项信息，申请上要包含所在地县或镇扶贫办的盖章）及其复印件。若已经在生源地办理的在报道当天交予财务处即可。
...
有时你可能需要找学校发布的官方文件或导员很早之前发过的通知，但是发现不是找不到就是找的不是想要的

#### QQ 等聊天软件内

- 直接在首页的搜索栏输入<mark>关键词</mark>查找聊天记录
- 看看群公告和群文件？说不定导员很早就发过了
