...
- 段末的句号不是必须的。你可以适当删除一些句末的句号以便降低文本的伪人感

### AI 辅助写作

:::warning

这个 Skill 并不是总是能生效或达到预期。使用后请务必自行核对
...
- 在提交前会自动使用[`@lint-md/cli`](https://github.com/lint-md/cli)、[`Prettier`](https://prettier.io/)等脚本自动修复部分问题
