...
入学后会安排大学英语分级考试，一般是穿插在军训期间。题型与全国大学英语四六级题型相似，包括听力、阅读、词汇与语法等。根据考试结果，将学生编入三个级别，各级别参加四级考试的时间会有所区别[^4]（[见下](#四级)）

## 报名要求

### 四级

- 报名时正在修读“通用英语(2)”`1500311B`及以上的课程 <Note>原文：修完大学英语四级课程的学生[^1]</Note>
  - 即：
    - 慢班的同学最快需要等到入学次年才能报名四级考试
    - 除了慢班以外的同学都可以在入学当年报名四级考试
- 已参加四级考试且分数高于 425 分的同学不可报名[^1]

### 六级

无论是快中慢班，只要四级考试分数高于 425 分后即可报名六级考试
...
[^1]:
    合肥工业大学宣城校区.关于 2025 年上半年全国大学英语四、六级考试报名的通知[DB/OL]. (2025-03-17)\[2025-06-29].  
